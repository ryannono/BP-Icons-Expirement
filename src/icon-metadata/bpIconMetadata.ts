export type BPIcon = (typeof bpIcons)[number];
...
export const bpIcons = [
  ...
  },
  {
    ...
    iconName: "clipboard",
    tags: "notepad, notebook, copy, transfer, storage, note",
    group: "action",
    codepoint: 61783,
  },
  {
  ...
  },
  {
    displayName: "Geotime",
    iconName: "geotime",
    tags: "geo, time, date, location, spatial",
    group: "interface",
    codepoint: 62276,
  },
  {
  ...
  },
  {
    ...
    iconName: "binary-number",
    tags: "data, type, number, numeric, format",
    group: "data",
    codepoint: 62295,
  },
  {
  ...
  },
  {
    displayName: "Vector",
    iconName: "vector",
    tags: "math, numbers, model, ml, array",
    group: "miscellaneous",
    codepoint: 62302,
  },
  {
  ...
  },
  {
    ...
    iconName: "data-sync",
    tags: "sync, stack, storage, can, data, source, dataset, data source, database",
    group: "data",
    codepoint: 62316,
  },
  {
  ...
  {
    displayName: "Range ring",
    iconName: "range-ring",
    tags: "layer, map, reference, point, geography, distance, boundry",
    group: "miscellaneous",
    codepoint: 62321,
  },
  {
    displayName: "Block promote",
    iconName: "block-promote",
    tags: "release, channel, upgrade, line, arrow, direction, next, forward",
    group: "interface",
    codepoint: 62322,
  },
  {
    displayName: "Cubes",
    iconName: "cubes",
    tags: "module, blocks, shapes, hexagons, stack, geometry",
    group: "miscellaneous",
    codepoint: 62323,
  },
  {
    displayName: "Hexagon",
    iconName: "hexagon",
    tags: "entity, shape, geometry, polygon",
    group: "miscellaneous",
    codepoint: 62324,
  },
  {
    displayName: "Package",
    iconName: "package",
    tags: "product, box, parcel, delivery, container, carton, archive",
    group: "file",
    codepoint: 62325,
  },
  {
    displayName: "Pill",
    iconName: "pill",
    tags: "label, capsule, medicine, health, drug, pharmaceutical",
    group: "miscellaneous",
    codepoint: 62326,
  },
  {
    displayName: "Server install",
    iconName: "server-install",
    tags: "environment, setup, network, IT, data, hosting, hardware",
    group: "interface",
    codepoint: 62327,
  },
  {
  ...
  },
  {
    displayName: "Tag add",
    iconName: "tag-add",
    tags: "release, publish, label, badge, identification, plus, create",
    group: "action",
    codepoint: 62329,
  },
  {
    displayName: "Tag promote",
    iconName: "tag-promote",
    tags: "release, label, badge, identification, upgrade, arrow, direction, next, forward",
    group: "action",
    codepoint: 62330,
  },
  {
    displayName: "Tag refresh",
    iconName: "tag-refresh",
    tags: "release, evaluate, label, badge, identification, update, sync",
    group: "action",
    codepoint: 62331,
  },
  {
    displayName: "Tag undo",
    iconName: "tag-undo",
    tags: "release, label, badge, identification, revert, recall, back, cancel, reverse, revoke, rollback",
    group: "action",
    codepoint: 62332,
  },
  {
    displayName: "Tags",
    iconName: "tags",
    tags: "releases, labels, badges, identification, multiple, organization",
    group: "action",
    codepoint: 62333,
  },
  {
    displayName: "Wrench redo",
    iconName: "wrench-redo",
    tags: "maintenance, override, tool, repair, spanner, work, fix, forward, window",
    group: "miscellaneous",
    codepoint: 62334,
  },
  {
    displayName: "Wrench snooze",
    iconName: "wrench-snooze",
    tags: "maintenance, suppress, tool, repair, spanner, work, delay, window",
    group: "miscellaneous",
    codepoint: 62335,
  },
  {
    displayName: "Wrench time",
    iconName: "wrench-time",
    tags: "maintenance, tool, repair, spanner, work, clock, duration, window",
    group: "miscellaneous",
    codepoint: 62336,
  },
  {
    displayName: "Panel",
    iconName: "panel",
    tags: "sidebar, layout, window, side bar, drawer, menu, website, dashboard",
    group: "table",
    codepoint: 62337,
  },
  {
    displayName: "Globe: network add",
    iconName: "globe-network-add",
    tags: "planet, earth, map, world, internet, website, create, plus",
    group: "miscellaneous",
    codepoint: 62338,
  },
  {
    displayName: "Cube: edit",
    iconName: "cube-edit",
    tags: "shape, 3d, object, box, module, block, geometry, change, modify, update",
    group: "miscellaneous",
    codepoint: 62339,
  },
  {
    ...
    tags: "shape, 3d, object, vehicle, military, flight, jet, fly, aircraft, aerospace",
    group: "interface",
    codepoint: 62340,
  },
  {
  ...
  {
    displayName: "Filter sort: ascending",
    iconName: "filter-sort-asc",
    tags: "sort, filter, ascending",
    group: "interface",
    codepoint: 62350,
  },
  {
    displayName: "Filter sort: descending",
    iconName: "filter-sort-desc",
    tags: "sort, filter, descending",
    group: "interface",
    codepoint: 62351,
  },
  {
  ...
  {
    displayName: "Data cloud",
    iconName: "data-cloud",
    tags: "data, source, data source, sync, cloud",
    group: "data",
    codepoint: 62353,
  },
  {
    displayName: "Join: subtract right",
    iconName: "subtract-right-join",
  ...
  },
  {
    ...
    tags: "speaker, megaphone, loud, noise",
    group: "miscellaneous",
    codepoint: 62358,
  },
  {
    displayName: "Phone Search",
    iconName: "phone-search",
    tags: "investigate, inspect, phone, magnify",
    group: "interface",
    codepoint: 62359,
  },
  {
    displayName: "Notifications: add",
    iconName: "notifications-add",
    tags: "notification, plus, new, alert",
    group: "interface",
    codepoint: 62360,
  },
  {
  ...
  },
  {
    ...
    iconName: "gift-box",
    tags: "gift, box, present, ribbon",
    group: "miscellaneous",
    codepoint: 62370,
  },
  {
    displayName: "Delete clip",
    iconName: "delete-clip",
    tags: "screenshot, segment, select, selector, delete, point, object, location, marker",
    group: "interface",
    codepoint: 62371,
  },
  {
    displayName: "Sweep",
    iconName: "sweep",
    tags: "broom, sweeper, broomstick, clean, linter, brush",
    group: "action",
    codepoint: 62372,
  },
  {
